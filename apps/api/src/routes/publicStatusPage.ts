  ...
  <main class="page">
    <section class="hero">
      <div class="brand-line">
        ...
        <span class="brand-name">CertWatch</span>
      </div>
      <div class="hero-grid">
        <div>
